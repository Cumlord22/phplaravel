<?php $__env->startSection('content'); ?>
    ...
    <div class="row">
        <div class="col-lg-12 text-center" style="margin-top: 10px;margin-bottom: 10px;">
            <a class="btn btn-success" href="<?php echo e(route('category.index')); ?>">
                Category
            </a>
        </div>
    </div>
...
<?php echo $__env->make('products.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\hi\IdeaProjects\pro_management\resources\views/products/index.blade.php ENDPATH**/ ?>